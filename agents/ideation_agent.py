...
REQUIREMENTS FOR HIGH-QUALITY IDEAS:
• Create SPECIFIC, CONCRETE concepts - avoid generic templates
• Include unique character types, not stereotypical protagonists
• Develop original conflicts that haven't been done to death
• Add unexpected twists or fresh takes on familiar themes
• Include vivid, memorable settings that enhance the story
• Ensure each idea has emotional depth and human stakes
• Make concepts that would intrigue readers immediately
